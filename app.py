...
def main():
    ...
    with col1:
        ...
        K = st.number_input("Enter Loading on Generator (K)", min_value=0.0)  # This is now an input
        ...
        # Button to calculate copper losses
        if st.button("Calculate Copper Losses"):
    ...
    with col2:
        if 'CUL' in locals():
            ...
            st.subheader("Results")
            st.write("Press the button to calculate copper losses.")
